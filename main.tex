...
$\qquad$ \qquad& \hspace{0.5cm} $\raisebox{-\totalheight}{\includegraphics[width=0.25\textwidth, height=11mm]{figures/jesper_signature_transparent.png}}$ \\ 
 ...
 $\qquad$ \qquad& \hspace{0.5cm} $\raisebox{-\totalheight}{\includegraphics[width=0.25\textwidth, height=12mm]{figures/Marco_signature_trans.png}}$ \\ 
 $\overline{\qquad\text{s154328}\qquad}$ \quad& \quad $\overline{\qquad\text{s193100}\qquad}$ \\
 $\raisebox{-\totalheight}{\includegraphics[width=0.25\textwidth, height=12mm]{figures/monica_signature_trans.png}}$ \qquad& \hspace{0.5cm} $\qquad$ \\ 
